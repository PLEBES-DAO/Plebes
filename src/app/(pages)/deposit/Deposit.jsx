...
const aggregatorTokens = {
    // USDC
    USDC: {
      logo: "/src/assets/img/coins/usdc.svg",
      networks: [
    ...
    // USDT
    USDT: {
      logo: "/src/assets/img/CoinsPlebes/USDT.svg",
      networks: [
    ...
    // BTC
    BTC: {
      logo: "/src/assets/img/CoinsPlebes/BTC.svg",
      networks: [
    ...
    // ETH
    ETH: {
      logo: "/src/assets/img/CoinsPlebes/ETH.svg",
      networks: [
        { aggregatorSymbol: "ETHARB", displayToken: "ETH", displayNetwork: "Arbitrum" },
    ...
    // ADA
    ADA: {
      logo: "/src/assets/img/CoinsPlebes/ADA.svg",
      networks: [
        { aggregatorSymbol: "ADA", displayToken: "ADA", displayNetwork: "Cardano" },
      ],
    },
  
    // ALGO
    ALGO: {
      logo: "/src/assets/img/CoinsPlebes/ALGO.svg",
      networks: [
        { aggregatorSymbol: "ALGO", displayToken: "ALGO", displayNetwork: "Algorand" },
      ],
    },
  
    // APT
    APT: {
      logo: "/src/assets/img/CoinsPlebes/APT.svg",
      networks: [
        { aggregatorSymbol: "APT", displayToken: "APT", displayNetwork: "Aptos" },
      ],
    },
  
    // ARB
    ARB: {
      logo: "/src/assets/img/CoinsPlebes/ARB.svg",
      networks: [
        { aggregatorSymbol: "ARB", displayToken: "ARB", displayNetwork: "Arbitrum" },
      ],
    },
  
    // AVAX
    AVAX: {
      logo: "/src/assets/img/CoinsPlebes/AVAX.svg",
      networks: [
        { aggregatorSymbol: "AVAX-C", displayToken: "AVAX", displayNetwork: "Avalanche (C-Chain)" },
      ],
    },
  
    // BNB
    BNB: {
      logo: "/src/assets/img/CoinsPlebes/BNB.svg",
      networks: [
        { aggregatorSymbol: "BNB-BSC", displayToken: "BNB", displayNetwork: "Binance Smart Chain (BSC)" },
      ],
    },
  
    // BUSD
    BUSD: {
      logo: "/src/assets/img/CoinsPlebes/BUSD.svg",
      networks: [
        { aggregatorSymbol: "BUSD", displayToken: "BUSD", displayNetwork: "Binance Smart Chain (BSC)" },
      ],
    },
  
    // DOGE
    DOGE: {
      logo: "/src/assets/img/CoinsPlebes/DOGE.svg",
      networks: [
        { aggregatorSymbol: "DOGE", displayToken: "DOGE", displayNetwork: "Dogecoin" },
      ],
    },
  
    // DOT
    DOT: {
      logo: "/src/assets/img/CoinsPlebes/DOT.svg",
      networks: [
        { aggregatorSymbol: "DOT", displayToken: "DOT", displayNetwork: "Polkadot" },
      ],
    },
  
    // ICP
    ICP: {
      logo: "/src/assets/img/CoinsPlebes/ICP.svg",
      networks: [
        { aggregatorSymbol: "ICP", displayToken: "ICP", displayNetwork: "Internet Computer" },
      ],
    },
  
    // NEAR
    NEAR: {
      logo: "/src/assets/img/CoinsPlebes/NEAR.svg",
      networks: [
    ...
    // OP
    OP: {
      logo: "/src/assets/img/CoinsPlebes/OP.svg",
      networks: [
        { aggregatorSymbol: "OP", displayToken: "OP", displayNetwork: "Optimism" },
      ],
    },
  
    // SOL
    SOL: {
      logo: "/src/assets/img/CoinsPlebes/SOL.svg",
      networks: [
    ...
    // SUI
    SUI: {
      logo: "/src/assets/img/CoinsPlebes/SUI.svg",
      networks: [
        { aggregatorSymbol: "SUI", displayToken: "SUI", displayNetwork: "Sui" },
      ],
    },
  
    // TON
    TON: {
      logo: "/src/assets/img/CoinsPlebes/TON.svg",
      networks: [
        { aggregatorSymbol: "TON", displayToken: "TON", displayNetwork: "Toncoin" },
      ],
    },
  
    // XLM
    XLM: {
      logo: "/src/assets/img/CoinsPlebes/XLM.svg",
      networks: [
        { aggregatorSymbol: "XLM", displayToken: "XLM", displayNetwork: "Stellar" },
      ],
    },
  
    // XRP
    XRP: {
      logo: "/src/assets/img/CoinsPlebes/XRP.svg",
      networks: [
        { aggregatorSymbol: "XRP", displayToken: "XRP", displayNetwork: "Ripple" },
      ],
    },
  
    // WLD
    WLD: {
      logo: "/src/assets/img/CoinsPlebes/WLD.svg",
      networks: [
        { aggregatorSymbol: "WLD", displayToken: "WLD", displayNetwork: "Worldcoin" },
      ],
    },
  };  
...
// Mapeo de “status” -> step 2..5 (porque step 1 es “Connect Wallet”)
function mapStatusToStep(status) {
  if (!status) return 2; // step 2 => "Awaiting deposit"
  if (status === "waiting") return 2;    // awaiting deposit
  if (status === "receiving") return 3;  // receiving tokens
  if (status === "swapping") return 4;   // swapping tokens
  if (status === "sending" || status === "finished") return 5; // sending / balance updated
  return 2;
}
...
const TokenRow = () => {
  ...
  async function handleCreateExchange() {
    ...
    const aggregatorSymbol = netOption.aggregatorSymbol;
    const aggregatorNetwork = netOption.displayNetwork.toLowerCase();
  ...
  return (
    <section className="relative pt-20 pb-24 lg:py-24">
      ...
      <div className="flex w-full">
        <div
          className="w-1/2 flex justify-start items-start mx-4 px-4"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        value={
                          apiResponse?.details?.deposit?.amount
                            ? `${apiResponse.details.deposit.amount} on ${
                                aggregatorTokens[selectedToken]?.networks?.[selectedNetworkIndex]?.displayNetwork
                              }`
                            : "0.00"
                        }
                        readOnly
              ...
              <div className="absolute w-full flex justify-between items-center px-12">
                ...
                {[1, 2, 3, 4, 5].map((num) => {
                  ...
                  return (
                    <div
                      key={num}
                      className={`w-12 h-12 text-lg font-bold rounded-full flex items-center justify-center z-10 transition-colors duration-300 ${
                        isActive ? "bg-accent text-white" : "bg-white text-jacarta-800"
                      }`}
                    >
                      {num}
                    </div>
