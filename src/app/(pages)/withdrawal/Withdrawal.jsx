...
const TokenRow = () => {
  ...
  // Estado para controlar qué botón está seleccionado (ckBTC u other)
  const [selectedButton, setSelectedButton] = useState("ckBTC");
  
  // Estado para los inputs adicionales
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-full">
            <label className="block text-xl font-medium text-jacarta-500 mb-1 dark:text-jacarta-100 munro-small-text">
                Choose the way you'd like to withdraw
            </label>
            
            
            {/* Botones ckBTC y other estilizados */}
            <div className="flex justify-center mt-4 space-x-4">
              <button 
                className={`bg-morado-translucido px-8 py-6 rounded-lg text-white text-center transition-all duration-300 ${selectedButton === 'ckBTC' ? 'ring-2 ring-white' : ''}`}
                onClick={() => setSelectedButton('ckBTC')}
              >
                <div className="balance-value-mini flex items-center justify-center">
                  <span className="pixel-font text-xs">ckBTC</span>
                </div>
              </button>
              
              <button 
                className={`bg-morado-translucido px-8 py-6 rounded-lg text-white text-center transition-all duration-300 ${selectedButton === 'other' ? 'ring-2 ring-white' : ''}`}
                onClick={() => setSelectedButton('other')}
              >
                <div className="balance-value-mini flex items-center justify-center">
                  <span className="pixel-font text-xs">other</span>
                </div>
              </button>
            </div>
            
            {/* Inputs condicionales basados en la selección del botón */}
            <div className="mt-6">
              {selectedButton === 'ckBTC' ? (
                <div className="space-y-4">
                  ...
                  {/* Botón Retirar para ckBTC */}
                  <div className="flex justify-center mt-4">
                    <button className="pitch-deck-button px-8 py-2 text-white rounded-lg shadow hover:bg-accent-dark focus:ring-2 focus:ring-offset-2 focus:ring-accent munro-narrow">
                      Retirar
                    </button>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      onChange={(e) => setGenericAddress(e.target.value)}
                      className="w-full p-2 border border-jacarta-600 rounded-lg bg-jacarta-800 focus:ring-accent focus:border-accent text-jacarta-100 dark:bg-jacarta-600 munro-small"
                    />
                  </div>
                  
                  {/* Botón Retirar para other */}
                  <div className="flex justify-center mt-4">
                    <button className="pitch-deck-button px-8 py-2 text-white rounded-lg shadow hover:bg-accent-dark focus:ring-2 focus:ring-offset-2 focus:ring-accent munro-narrow">
                      Retirar
                    </button>
          ...
          {/* El selector de redes solo se muestra si no hay ningún botón seleccionado */}
          {selectedButton === '' && (
            <div className="w-full">
              <label className="block text-xl font-medium text-jacarta-500 mb-1 dark:text-jacarta-100 munro-small-text">
                Address to deposit
  ...
  return (
    <section className="relative h-screen">
      <div className="mx-4 text-center pt-24 md:pt-32">
        <span className="text-white text-2xl md:text-5xl munro-regular-heading">Multichain Withdrawal</span>
      </div>
            ...
            <div className="text-center text-white">
              {rightStep === 1 && (
                <div>
                  ...
                  <p className="text-xl md:text-2xl munro-small-text">GET YOUR TOKENS</p>
                </div>
              )}
              {rightStep === 2 && (
                <div>
